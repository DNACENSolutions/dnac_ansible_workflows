...
2. Copy the sample workflow data from `workflows/reports/vars/reports_input.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `reports_details`.
