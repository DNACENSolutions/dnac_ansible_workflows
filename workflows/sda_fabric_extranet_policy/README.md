...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./workflows/sda_fabric_extranet_policy/playbook/fabric_extranet_policy_playbook.yml -vvvv
```
...
2. Copy the sample workflow data from `workflows/sda_fabric_extranet_policy/vars/fabric_extranet_policy_inputs.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `extranet_policies`.
4. Run the playbook without `VARS_FILE_PATH`:

```bash
ansible-playbook -i <inventory-file> workflows/sda_fabric_extranet_policy/playbook/fabric_extranet_policy_playbook.yml -vvvv
```
...
- Relative to the playbook: `../vars/fabric_extranet_policy_inputs.yml`
- Fully resolved from the repo root: `${PWD}/workflows/sda_fabric_extranet_policy/vars/fabric_extranet_policy_inputs.yml`
