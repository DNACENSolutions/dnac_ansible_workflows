...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./workflows/network_profile_wireless/playbook/network_profile_wireless_playbook.yml -vvvv
```
...
2. Copy the sample workflow data from `workflows/network_profile_wireless/vars/network_profile_wireless_inputs.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `wireless_nw_profiles_details`.
