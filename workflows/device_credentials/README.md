...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./workflows/device_credentials/playbook/device_credentials_playbook.yml -vvvv
```
...
2. Copy the sample workflow data from `workflows/device_credentials/vars/device_credentials_vars.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `device_credentials`.
4. Run the playbook without `VARS_FILE_PATH`:

```bash
ansible-playbook -i <inventory-file> workflows/device_credentials/playbook/device_credentials_playbook.yml -vvvv
```
...
- Relative to the playbook: `../vars/device_credentials_vars.yml`
- Fully resolved from the repo root: `${PWD}/workflows/device_credentials/vars/device_credentials_vars.yml`
