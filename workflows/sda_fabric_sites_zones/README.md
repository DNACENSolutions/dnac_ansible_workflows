...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./workflows/sda_fabric_sites_zones/playbook/sda_fabric_sites_zones_playbook.yml -vvvv
```
...
- Relative to the playbook: `../vars/sda_fabric_sites_zones_inputs.yml`
- Fully resolved from the repo root: `${PWD}/workflows/sda_fabric_sites_zones/vars/sda_fabric_sites_zones_inputs.yml`
