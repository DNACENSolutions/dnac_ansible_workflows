...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./workflows/assurance_intelligent_capture/playbook/assurance_intelligent_capture_playbook.yml -vvvv
```
...
2. Copy the sample workflow data from `workflows/assurance_intelligent_capture/vars/assurance_intelligent_capture_inputs.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `assurance_inteligent_capture_settings`.
