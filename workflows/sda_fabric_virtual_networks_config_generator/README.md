...
./tools/schemavalidation.sh -s workflows/sda_fabric_virtual_networks_config_generator/schema/sda_fabric_virtual_networks_config_schema.yml \
  -v workflows/sda_fabric_virtual_networks_config_generator/vars/sda_fabric_virtual_networks_config_inputs.yml
...
ansible-playbook -i inventory/demo_lab/hosts.yaml \
  ...
  --extra-vars VARS_FILE_PATH=${PWD}/workflows/sda_fabric_virtual_networks_config_generator/vars/sda_fabric_virtual_networks_config_inputs.yml
```
...
2. Copy the sample workflow data from `workflows/sda_fabric_virtual_networks_config_generator/vars/sda_fabric_virtual_networks_config_inputs.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `sda_fabric_virtual_networks_config`.
4. Run the playbook without `VARS_FILE_PATH`:

```bash
ansible-playbook -i <inventory-file> workflows/sda_fabric_virtual_networks_config_generator/playbook/sda_fabric_virtual_networks_config_generator.yml -vvvv
```
...
- Fully resolved from the repo root: `${PWD}/workflows/sda_fabric_virtual_networks_config_generator/vars/sda_fabric_virtual_networks_config_inputs.yml`
