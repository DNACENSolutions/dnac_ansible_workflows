...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./workflows/sda_fabric_device_roles/playbook/sda_fabric_device_roles_playbook.yml -vvvv
```
...
2. Copy the sample workflow data from `workflows/sda_fabric_device_roles/vars/sda_fabric_device_roles_input.yml` into that inventory vars file.
