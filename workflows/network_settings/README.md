...
ansible-playbook -i host_inventory_dnac1/hosts.yml workflows/network_settings/playbook/delete_settings_playbook.yml --e VARS_FILE_PATH=../vars/network_settings_vars.yml -vvv
