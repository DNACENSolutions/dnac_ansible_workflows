...
2. Copy the sample workflow data from `workflows/access_point_location/vars/access_point_location_inputs.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `accesspoint_location_details`.
