...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./workflows/network_compliance/playbook/network_compliance_workflow_playbook.yml -vvvv
```
...
2. Copy the sample workflow data from `workflows/network_compliance/vars/network_compliance_workflow_input.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `network_compliance_details`.
