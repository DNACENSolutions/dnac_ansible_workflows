...
ansible-playbook -i ./inventory/demo_lab/hosts.yaml ./workflows/sda_virtual_networks_l2l3_gateways/playbook/sda_virtual_networks_l2_l3_gateways_playbook.yml -vvvv
```
...
2. Copy the sample workflow data from `workflows/sda_virtual_networks_l2l3_gateways/vars/sda_virtual_networks_l2_l3_gateways_input.yml` into that inventory vars file.
3. Keep the same top-level variable name in inventory: `sda_fabric_virtual_networks_details`.
